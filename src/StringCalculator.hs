...
add :: String -> Int
add "" = 0
add numbers = sum . thousandOrLess . processNegs . intList . numsList $ numbers
...
thousandOrLess :: [Int] -> [Int]
thousandOrLess integers = filter ( <= 1000 ) integers
